...
redistribution, so each user must obtain it independently at the locked revision:
...
SAGE discovers this local clone by default. Set `SAGE_SPNET_ROOT` only to use another verified clone.
