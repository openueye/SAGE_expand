"""Identity capture and validation for published SAGE artifacts."""
...
from .frame_source import FrameSource, frame_source_for_config
from .scene import PreparedScene, scene_content_sha256, sha256_file
